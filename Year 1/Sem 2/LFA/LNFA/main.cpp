...
void citire_QEFD(int &nrStari, set <int> &Q, int &nrLitere, set <char> &Epsilon, int &q0, int &nrStariFinale, set <int> &F, int &nrTranzitii, map <pair <int, char>, set <int> > &delta)
{
    int auxInt;
    char auxChar;
...
int main()
{
    ...
    citire_QEFD(nrStari, Q, nrLitere, Epsilon, q0, nrStariFinale, F, nrTranzitii, delta);
